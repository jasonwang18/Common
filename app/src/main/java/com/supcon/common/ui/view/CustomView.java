...
public class CustomView extends BaseLinearLayout implements ICustomView{
    ...
    protected void initListener() {
        ...
        findViewById(R.id.customText).setOnClickListener(v -> onChildViewClick(findViewById(R.id.customText), 0, "customText"));
        customSpinner.setOnClickListener(v -> onChildViewClick(customSpinner, 0));
        customDate.setOnClickListener(v -> onChildViewClick(customDate, 0));
    }
