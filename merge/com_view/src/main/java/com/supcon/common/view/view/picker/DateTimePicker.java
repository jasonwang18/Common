...
//    private String hourLabel = "时", minuteLabel = "分", secondLabel = "秒";
    ...
    private String hourLabel = ":", minuteLabel = ":", secondLabel = "";
    ...
    public void isSecondVisible(boolean isSecondVisible){
        this.isSecondVisible = isSecondVisible;
    }
    ...
    protected View makeCenterView() {
        ...
        if (timeMode != NONE && seconds.size() == 0 && isSecondVisible) {
        ...
        if (timeMode != NONE) {
            ...
            if (!TextUtils.isEmpty(minuteLabel)&& isSecondVisible) {
                TextView labelView = createLabelView();
                labelView.setTextSize(textSize);
            ...
            if(isSecondVisible) {
                ...
                secondView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
                    @Override
                    public void onSelected(int index) {
                        selectedSecond = seconds.get(index);
                        if (onWheelListener != null) {
                            onWheelListener.onSecondWheeled(index, selectedSecond);
                        }
                    }
                });
    ...
    protected void onSubmit() {
        ...
        switch (dateMode) {
            case YEAR_MONTH_DAY:
                ...
                break;
            case YEAR_MONTH:
                ((OnYearMonthTimePickListener) onDateTimePickListener).onDateTimePicked(year, month, hour, minute, second);
                break;
            case MONTH_DAY:
                ((OnMonthDayTimePickListener) onDateTimePickListener).onDateTimePicked(month, day, hour, minute, second);
                break;
            case NONE:
    ...
    private void initSeconds() {
        ...
        if (minutes.indexOf(selectedSecond) == -1) {
            //当前设置的分钟不在指定范围，则默认选中范围开始的分钟
    ...
    public interface OnYearMonthTimePickListener extends OnDateTimePickListener {
        ...
        void onDateTimePicked(String year, String month, String hour, String minute, String second);
    ...
    public interface OnMonthDayTimePickListener extends OnDateTimePickListener {
        ...
        void onDateTimePicked(String month, String day, String hour, String minute, String second);
    }
