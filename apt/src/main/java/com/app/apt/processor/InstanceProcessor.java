...
public class InstanceProcessor implements IProcessor {
    ...
    public void process(RoundEnvironment roundEnv, AnnotationProcessor mAbstractProcessor) {
        ...
        TypeSpec.Builder tb = classBuilder(CLASS_NAME)
                ...
                .addJavadoc("@ instance factory, created by apt automatically\n");

        MethodSpec.Builder methodBuilder1 = MethodSpec.methodBuilder("create")/*.addAnnotation(Memory.class)*/
                .addJavadoc("@ method created by apt automatically\n")
