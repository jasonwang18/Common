...
public class SwipeBackLayout extends ViewGroup {
    ...
    public static final int ERROR_MSG_DISABLE = 1;
    public static final int ERROR_MSG_MODIFIED = ERROR_MSG_DISABLE+1;
    ...
    public boolean isSwipeBackEnable() {
        return mSwipeBackEnable && App.getAppContext().isSwipeBackEnable();
    }
    ...
    public interface PanelSlideListener {
        ...
        /**
         * Called when a sliding pane becomes slide.
         *
         * @param errorCode The reason why sliding stopped;
         */
        void onPanelStop(int errorCode);
    ...
    public static class SimplePanelSlideListener implements PanelSlideListener {
        @Override
        public void onPanelStop(int errorCode) {
...
//        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density + 0.5f);
    ...
    void dispatchOnPanelStop(int errorCode) {
        if (mPanelSlideListener != null) {
            mPanelSlideListener.onPanelStop(errorCode);
        }
    }
...
//        int widthSize = MeasureSpec.getSize(widthMeasureSpec);
        int widthSize = Util.getRealScreenWidth(mActivity);
//        int heightSize = MeasureSpec.getSize(heightMeasureSpec);
        int heightSize = Util.getRealScreenHeight(mActivity);
        // ======================== 新加的 END ========================
        ...
        // ======================== 新加的 START ========================
        if (!mIsNavigationBarOverlap && Util.isPortrait(mActivity)) {
            maxLayoutHeight -= Util.getNavigationBarHeight(mActivity);
        }

        if (mIsNavigationBarOverlap && !Util.isPortrait(mActivity)) {
            widthSize += Util.getNavigationBarHeight(mActivity);
        }
        // ======================== 新加的 END ========================
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (!isSwipeBackEnable()) {
            mDragHelper.cancel();
            dispatchOnPanelStop(ERROR_MSG_DISABLE);
            return super.onInterceptTouchEvent(ev);
        }
        // ======================== 新加的 END ========================

//        if (mActivity instanceof IData && ((IData)mActivity).isModified()) {
//            mDragHelper.cancel();
//            dispatchOnPanelStop(ERROR_MSG_MODIFIED);
//            return super.onInterceptTouchEvent(ev);
//        }
