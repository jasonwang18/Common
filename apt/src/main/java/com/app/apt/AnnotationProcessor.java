...
import com.app.apt.processor.ContractFactoryProcessor;
import com.app.apt.processor.InstanceProcessor;
import com.app.apt.processor.MultiRouterProcessor;
...
//        "com.app.annotation.apt.InstanceFactory",
        ...
        "com.app.annotation.apt.Router.ContractFactory"
})
...
//        new InstanceProcessor().process(roundEnv, this);
        ...
        new MultiRouterProcessor().process(roundEnv, this);
//        new RouterProcessor().process(roundEnv, this);
        new ContractFactoryProcessor().process(roundEnv, this);
        return true;
    }
}
